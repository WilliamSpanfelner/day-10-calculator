...
- 🧑‍💻  Take user input use functions and higher order functions to present the result. Loads of scope for expansion.
...
# References:
[Higher Order Functions and Decorators](https://www.hackerearth.com/practice/python/functional-programming/higher-order-functions-and-decorators/tutorial/)
